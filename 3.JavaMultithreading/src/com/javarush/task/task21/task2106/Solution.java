...
public class Solution {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Solution solution = new Solution(5, "Ooops!", 2.5d, new SimpleDateFormat("dd.MM.yyyy").parse("25.14.2020"), new Solution());
        set.add(solution);
        System.out.print(set.contains(new Solution(5, "Ooops!", 2.5d, new SimpleDateFormat("dd.MM.yyyy").parse("25.12.2020"), solution)));
